...
/**
 * Gravitino Iceberg catalog for Spark 3.4, adding read-only view support via {@link ViewCatalog}.
 */
public class GravitinoIcebergCatalogSpark34 extends GravitinoIcebergCatalog implements ViewCatalog {

  private static final Logger LOG = LoggerFactory.getLogger(GravitinoIcebergCatalogSpark34.class);
