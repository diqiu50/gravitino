CREATE SCHEMA gt_glue.gt_array_db1;

USE gt_glue.gt_array_db1;
...
DROP TABLE gt_glue.gt_array_db1.tb01;

DROP TABLE gt_glue.gt_array_db1.tb02;

DROP TABLE gt_glue.gt_array_db1.tb03;

DROP TABLE gt_glue.gt_array_db1.tb04;

DROP TABLE gt_glue.gt_array_db1.tb05;

DROP TABLE gt_glue.gt_array_db1.tb06;

DROP SCHEMA gt_glue.gt_array_db1;
